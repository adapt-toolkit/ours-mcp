...
assert.match(missing.stderr, /Install @ours\.network\/cli@2\.7\.2/);
...
assert.match(source, /Install @ours\.network\/cli@2\.7\.2/, 'missing delegated CLI reports exact install guidance');
