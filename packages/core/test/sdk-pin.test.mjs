...
assert.equal(pkg.dependencies['@ours.network/sdk'], '3.8.1-nightly.4', 'SDK must stay exactly pinned');
assert.equal(pkg.dependencies['@ours.network/cli'], '2.8.1-nightly.2', 'CLI must stay exactly pinned');
...
assert.equal(sdk.value.version, '3.8.1-nightly.4');
...
assert.equal(cli.version, '2.8.1-nightly.2');
...
for (const [path, version] of [
  ['node_modules/@ours.network/sdk', '3.8.1-nightly.4'],
  ['node_modules/@ours.network/cli', '2.8.1-nightly.2'],
]) {
...
console.log('sdk-pin: SDK 3.8.1-nightly.4 and CLI 2.8.1-nightly.2 registry pins verified');
