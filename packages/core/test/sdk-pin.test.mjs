...
assert.equal(pkg.dependencies['@ours.network/sdk'], '3.8.1-nightly.3', 'SDK must stay exactly pinned');
assert.equal(pkg.dependencies['@ours.network/cli'], '2.8.1-nightly.1', 'CLI must stay exactly pinned');
...
assert.equal(sdk.value.version, '3.8.1-nightly.3');
...
assert.equal(cli.version, '2.8.1-nightly.1');
...
for (const [path, version] of [
  ['node_modules/@ours.network/sdk', '3.8.1-nightly.3'],
  ['node_modules/@ours.network/cli', '2.8.1-nightly.1'],
]) {
...
console.log('sdk-pin: SDK 3.8.1-nightly.3 and CLI 2.8.1-nightly.1 registry pins verified');
